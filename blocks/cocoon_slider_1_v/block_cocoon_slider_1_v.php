...
class block_cocoon_slider_1_v extends block_base {
  ...
  function get_content() {
    ...
    if(!empty($this->config->image) && isset($files) && count($files) >= 1){$this->content->image = $this->config->image;} else { $this->content->image = $CFG->wwwroot.'/theme/edumy/images/home/1.jpg';}
